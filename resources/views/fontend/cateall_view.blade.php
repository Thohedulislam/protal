                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                            ...
                            <a class="text-secondary font-weight-medium text-decoration-none" href="{{ url('cate_wise_post', $cat->id) }}">View All</a>
                        </div>
                    </div>
                    @foreach (App\Models\Post::Where('cate_id',$cat->id)->get() as $key=>$post)
                    <div {{$key++}} class="col-lg-6">
                        <div class="position-relative mb-3">
                            ...
                            <div class="overlay position-relative bg-light">
                                ...
                                <a class="h4" href="{{ url('post-view', $post->id) }}">{{Str::words($post->title, 4)}}</a>
                                <p class="m-0">{{Str::words($post->description , 10)}}</p>
                            </div>
