        ...
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-uppercase"><span class="text-primary">News</span>AJKAL</h1>
                </a>
            </div>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="{{url('/home')}}" class="nav-item nav-link {{'home' == request()->path ()?'active':''}}">Home</a>
                    <a href="{{url('/view_all_cate')}}" class="nav-item nav-link {{'view_all_cate' == request()->path ()?'active':''}}">Categories</a>
                    ...
                    <a href="contact.html" class="nav-item nav-link {{'/' == request()->path ()?'active':''}}">Contact</a>
                </div>
