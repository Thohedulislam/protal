 ...
 <div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <span class="breadcrumb-item active">{{ $cate->name }}</span>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
                    ...
                    @foreach ($post as $item)
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{ asset('uploads/demo/'.$item->image) }}" style="object-fit: cover;width: 100px; height: 175px;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <a href="">@if(!empty($item->cate->name)) {{ $item->cate->name }} @endif</a>
                                        <span class="px-1">/</span>
                                        <span>{{$item->created_at->format('M-d-Y')}}</span>
                                    </div>
                                    <a class="h4" href="{{url('post-view',$item->id)}}">{{$item->title}}</a>
                                    <p class="m-0">{{ Str::words($item->description, 10) }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
